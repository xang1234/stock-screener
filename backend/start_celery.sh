...
./venv/bin/celery -A app.celery_app worker \
    ...
    --pool="$POOL" \
    --concurrency=1 \
    -Q data_fetch_shared,data_fetch_us,data_fetch_hk,data_fetch_in,data_fetch_jp,data_fetch_kr,data_fetch_tw,data_fetch_cn,data_fetch_ca,data_fetch_de,data_fetch_sg \
