...
class Settings(BaseSettings):
    ...
    # Defaults are at or after close + 1h45m in the market calendar service.
    cache_warm_hour_us: int = 17
    cache_warm_minute_us: int = 45
    cache_warm_hour_hk: int = 5
    cache_warm_minute_hk: int = 45
    cache_warm_hour_in: int = 7
    cache_warm_minute_in: int = 45
    cache_warm_hour_jp: int = 3
    cache_warm_minute_jp: int = 45
    cache_warm_hour_tw: int = 3
    cache_warm_minute_tw: int = 15
