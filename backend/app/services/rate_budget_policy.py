...
class RateBudgetPolicy:
    ...
    _DEFAULT_BATCH_SIZE: Dict[str, Dict[str, int]] = {
        ...
        "yfinance": {"US": 150, "HK": 50, "IN": 50, "JP": 50, "KR": 50, "TW": 50},
        "finviz":   {"US": 100, "HK": 50, "IN": 50, "JP": 50, "KR": 50, "TW": 50},
    }
