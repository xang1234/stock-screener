...
class RateBudgetPolicy:
    ...
    _DEFAULT_BATCH_SIZE: Dict[str, Dict[str, int]] = {
        ...
        "yfinance": {"US": 150, "HK": 50, "IN": 50, "JP": 50, "KR": 50, "TW": 50, "CN": 25, "SG": 50, "CA": 50, "DE": 50, "AU": 50},
        "finviz":   {"US": 100, "HK": 50, "IN": 50, "JP": 50, "KR": 50, "TW": 50, "CN": 50, "SG": 50, "CA": 50, "DE": 50, "AU": 50},
    }
    ...
    _DEFAULT_PROVIDER_WORKERS: Dict[str, Dict[str, int]] = {
        ...
        "finviz": {"US": 4, "HK": 2, "IN": 2, "JP": 2, "KR": 2, "TW": 2, "CN": 1, "SG": 2, "CA": 2, "DE": 2, "AU": 2},
        # yfinance batch is already a single bulk HTTP call; threading
        # there caused fork issues in Celery workers, so default to 1.
        "yfinance": {"US": 1, "HK": 1, "IN": 1, "JP": 1, "KR": 1, "TW": 1, "CN": 1, "SG": 1, "CA": 1, "DE": 1, "AU": 1},
    }
    ...
    _DEFAULT_BACKOFF: Dict[str, Dict[str, dict]] = {
        "yfinance": {
            ...
            "SG": {"base_s": 60, "max_s": 600, "factor": 2.0},
        ...
        "finviz": {
            ...
            "SG": {"base_s": 60, "max_s": 480, "factor": 2.0},
