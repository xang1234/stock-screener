...
from app.domain.social_signals.records import (
    ...
    SocialRunResult,
    SocialSourceBatch,
    PreparedSocialPublication, SavedSocialRunInputs, SocialSnapshotRecord, ThemeMarketEvidence, SocialPublicationContext,
)
...
class SocialWriter(Protocol):
    ...
    def create_replay_run(self, run_id: str, saved_run_id: str, as_of: datetime) -> str: ...
    ...
    def select_current_inputs(self, run_id: str) -> SavedSocialRunInputs: ...

    def current_inputs_ready(self, run_id: str) -> bool: ...

    def read_publication_context(self, run_id: str) -> SocialPublicationContext | None: ...

    def prepare_run(self, run_id: str, rows: tuple[SocialSnapshotRecord, ...], as_of: datetime,
                    *, theme_evidence: tuple[ThemeMarketEvidence, ...] = (),
                    context: SocialPublicationContext | None = None) -> PreparedSocialPublication: ...
