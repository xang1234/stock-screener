...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("core_valid", sa.Boolean(), nullable=False, server_default=sa.false()),
        ...
        sa.Column("max_pain_change_5", sa.Float(), nullable=True),
        sa.Column("net_gex_change_5", sa.Float(), nullable=True),
        sa.Column("gamma_flip_change_5", sa.Float(), nullable=True),
        sa.Column("atm_iv_change_5", sa.Float(), nullable=True),
        sa.Column("skew_25_delta_change_5", sa.Float(), nullable=True),
        sa.Column("realized_volatility_change_5", sa.Float(), nullable=True),
        sa.Column("vrp_change_5", sa.Float(), nullable=True),
        sa.Column("activity_intensity_change_5", sa.Float(), nullable=True),
        sa.Column("activity_rank", sa.Integer(), nullable=True),
        sa.Column("call_open_interest", sa.BigInteger(), nullable=True),
        ...
        sa.Column("highest_contract_activity_ratio", sa.Float(), nullable=True),
