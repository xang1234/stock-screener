...
Begin by auditing the repository's existing public news/RSS candidates: Yahoo Finance, MarketWatch, Doomberg, and SentimenTrader. Their presence in configuration does not establish accessibility, full-text availability, or historical completeness. Record those facts before selecting a corpus.
...
No social authentication or paid historical archive is a prerequisite for the first pilot. Additional source types can be admitted later under the same manifest rules.
