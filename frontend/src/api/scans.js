 ...
 * @param {string} [params.universe_def.market] - Market code: 'US', 'HK', 'IN', 'JP', 'KR', 'TW', 'CN', 'SG', 'CA', 'DE' (if type='market', optional for type='exchange')
 ...
 * @param {string} params.market - Market code: US, HK, IN, JP, KR, TW, CN, SG, CA, or DE
